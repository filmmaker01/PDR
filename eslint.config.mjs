...
export default tseslint.config(
  ...
  {
    // Псевдоним пути переписывается при сборке только в статических импортах.
    ...
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'Динамический import с псевдонимом @/ не резолвится в собранном приложении. Используйте обычный импорт наверху файла.',
        },
      ],
    },
  },
